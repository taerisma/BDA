...
Aus dem Verhältnis von reflektiertem zu gesendetem Signal wird die Reflexion, das heisst der Reflexionskoeffizient gemessen. Weiter wird die Dämpfung des reflektierten Signals  in Abhängigkeit der Frequenz aufgezeichnet und dargestellt. Dies wird als Rückflussdämpfung  oder als $S_{11}$-Wert in dB angegeben. Diese wird in  der englischen Literatur \textit{Return Loss} genannt.
