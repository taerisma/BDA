...
calltrk_nearestTLD = function() {
  ...
  for(var i = pieces.length - 1; i >= 0; i--) {
    ...
    namespace_266475151.createCookie('calltrk_nearest_tld', domain, 365, domain);
    if (cookieStr !== document.cookie) {
      namespace_266475151.eraseCookie('calltrk_nearest_tld', domain)
...
namespace_266475151.createCookie = function(name,value,days,domain) {
  if (days) {
    var date = new Date();
...
namespace_266475151.readTransitionalCookie = function(name) {
  var session_ids = namespace_266475151.cookieValues(name);
  if (session_ids.length > 1) {
    namespace_266475151.eraseCookie(name);
    return namespace_266475151.readCookie(name);
  } else {
    return session_ids[0];
  }
};

namespace_266475151.cookieValues = function(name) {
  var nameEQ = name + "=";
...
namespace_266475151.readCookie = function(name) {
  var nameEQ = name + "=";
  var ca = document.cookie.split(';');
  for(var i=0;i < ca.length;i++) {
    var c = ca[i];
...
namespace_266475151.eraseCookie = function(name, domain) {
  namespace_266475151.createCookie(name,"",-1,domain);
};
...
namespace_266475151.getReferrer = function(){
  var referrer = namespace_266475151.readTransitionalCookie('calltrk_referrer');
  if (!referrer) {
    referrer = namespace_266475151.getCurrentReferrer();
  }
  namespace_266475151.createCookie('calltrk_referrer', referrer, 365, calltrk_nearestTLD());
  return referrer;
}

// Returns the current referrer without looking at the cookie
namespace_266475151.getCurrentReferrer = function(){
  var referrer;
  if(namespace_266475151.getURLParameter('utm_referrer')){
    referrer = namespace_266475151.getURLParameter('utm_referrer');
  }else{
...
namespace_266475151.getLanding = function(){
  var landing = namespace_266475151.readTransitionalCookie('calltrk_landing');
  if (!landing) {
    landing = document.URL;
  }
  namespace_266475151.createCookie('calltrk_landing', landing, 365, calltrk_nearestTLD());
  return landing;
}

// Returns the current landing without looking at the cookie
namespace_266475151.getCurrentLanding = function(){
  var landing;
  landing = document.URL;
  return landing;
}

namespace_266475151.getReferrerKey = function(referrer, landing){
  var referrer_key;
  if(referrer.match(/^(.*)doubleclick(.*)$/) || landing.match(/^(.*)gclid=(.*)$/)) {
    ...
    referrer_key = namespace_266475151.getReferrerDomain(referrer);
  }
  return referrer_key;
}

// Get the domain name of the referrer
namespace_266475151.getReferrerDomain = function(referrer){
...
namespace_266475151.checkLanding = function(landing, target){
  return (landing.indexOf(target) !== -1);
}

namespace_266475151.getHostnameAndPath = function() {
  var temp_a = document.createElement("a");
  temp_a.href = document.location.href;
  return temp_a.hostname + temp_a.pathname;
}

namespace_266475151.getURLParameter = function(name) {
  return decodeURIComponent((new RegExp('[?|&]' + name + '=' + '([^&;]+?)(&|#|;|$)').exec(location.search)||[,""])[1].replace(/\+/g, '%20'))||null;
}



namespace_266475151.makePhoneSwapVisible = function(){
  calltrk_jq('.phoneswap').css("visibility", "visible");
}


namespace_266475151.swapPhoneNumber = function(old_number, new_number) {
  ...
  namespace_266475151.makePhoneSwapVisible();
}
...
namespace_266475151.swapPhonePlainText = function(search_text, replacement_text, replacement_number){
...
namespace_266475151.swapPhonePlainTextForUpdate = function(replacement_text, old_number, replacement_number){
  var old_123 = old_number.substring(0,3);
  var old_456 = old_number.substring(3,6);
  var old_6789 = old_number.substring(6,10);
...
namespace_266475151.checkPhonePlainText = function(search_text){
...
namespace_266475151.getVWOCookies = function() {
...
namespace_266475151.getUnbounceCookies = function() {
  var unbounce_variations;
  if(namespace_266475151.readCookie('calltrk_unbounce_variations')){
    unbounce_variations = namespace_266475151.readCookie('calltrk_unbounce_variations');
  }else{
    unbounce_variations = '';
  }

  if(namespace_266475151.readCookie('ubpv')){
    variation = namespace_266475151.readCookie('ubpv')[0];
    current_page = namespace_266475151.getHostnameAndPath();
    ...
    namespace_266475151.createCookie('calltrk_unbounce_variations', unbounce_variations, 365);
  }

  return unbounce_variations;
}

namespace_266475151.getGoogleContentExperimentCookies = function() {
  var google_experiments;
  if(namespace_266475151.readCookie('calltrk_google_experiments')){
    google_experiments = namespace_266475151.readCookie('calltrk_google_experiments');
  }else{
    google_experiments = '';
  }

  if(namespace_266475151.getURLParameter('utm_expid')){
    experiment = namespace_266475151.getURLParameter('utm_expid');
    current_page = namespace_266475151.getHostnameAndPath();
    ...
    namespace_266475151.createCookie('calltrk_google_experiments', google_experiments, 365);
  }

  return google_experiments;
}

namespace_266475151.getMarketoCookies = function() {
  var marketo_cookie;
  if(namespace_266475151.readCookie('_mkto_trk')){
    marketo_cookie = namespace_266475151.readCookie('_mkto_trk');
  }else{
    marketo_cookie = '';
  }
...
namespace_266475151.getSecondScript = function(sessionSwapTargets, record_pageview, domless){
  var ns = namespace_266475151;
  var params = {
  ...
  calltrk_jq.ajax({
    url: "//app.calltrk.com/companies/266475151/c8c6fef00ee1dfbd389f/10/swap_session.js",
    dataType: 'script',
    cache: false,
    data: params
  })
...
namespace_266475151._log = [];
namespace_266475151._dolog = (window.location.href.indexOf("crdbg") != -1)
namespace_266475151.log = function(what) {
  if (namespace_266475151._dolog) {
    namespace_266475151._log.push(what);
  }
}

namespace_266475151.startSessionSwap = function(reassigns) {
  var swaps = namespace_266475151.getStoredSwaps();
  var replaceNumber;
  ...
  for(var target in swaps) {
    if (target.indexOf(',') === -1) {
      namespace_266475151.swapPhoneNumber(target, swaps[target]);
    } else {
      ...
      if (calltrk_jq.isArray(swaps[target])) {
        ...
        namespace_266475151.swapPhonePlainTextForUpdate(newSearch, newReplace, 'xxxxxxxxxx');
      } else {
        namespace_266475151.swapPhonePlainText(search_text, replacement_text, swaps[target]);
      }
    }
  }
...
namespace_266475151.getSessionSources = function(swapTarget) {
  return namespace_266475151.swapTargets[swapTarget];
}

namespace_266475151.findSwapTargets = function() {
  var targets = [];
  ...
  for (var i = 0; i < exactTargets.length; i++) {
    ...
    if (namespace_266475151.checkPhonePlainText(swapText)) {
...
namespace_266475151.checkSessionSwap = function() {
  namespace_266475151.checkSessionSwapInternal(true);
}

namespace_266475151.setStoredSwaps = function(swaps) {
  var cookieStrings = [];
  for(var target in swaps) {
    if (!swaps[target]) {
      continue;
  ...
  namespace_266475151.createCookie('calltrk_session_swap_numbers_266475151', cookieStr, 365, calltrk_nearestTLD());
};

namespace_266475151.mergeStoredSwaps = function(swaps) {
  var swapsStored = namespace_266475151.getStoredSwaps();
  for (var target in swaps) {
  ...
  namespace_266475151.setStoredSwaps(swapsStored);
};

namespace_266475151.getStoredSwaps = function() {
  var swap, result;
  var swapsStored = namespace_266475151.readCookie('calltrk_session_swap_numbers_266475151');
...
namespace_266475151.domlessSessionSwap = function(numbers, callback) {
  ...
  namespace_266475151.swapCallback = callback;
  namespace_266475151.getSecondScript(swapsToVerify, false, true);
};

namespace_266475151.checkSessionSwapInternal = function(recordPageView, domlessNumbers, domlessCallback) {
  var swapsToVerify = {};
  var possibleTargets = namespace_266475151.findSwapTargets();
  var storedSwaps = namespace_266475151.getStoredSwaps();
  ...
  if (foundStoredTarget) {
    ...
    namespace_266475151.addLoadEvent(namespace_266475151.startSessionSwap);
  }
  ...
  namespace_266475151.getSecondScript(swapsToVerify, recordPageView);
};

namespace_266475151.swapPhoneForUpdate = function(reassigns){
  namespace_266475151.startSessionSwap(reassigns);
...
namespace_266475151.getSessionID = function(){
  var idKey = 'calltrk_session_id_266475151';
  var session_id = namespace_266475151.readTransitionalCookie(idKey);

  if (!session_id) {
    session_id = namespace_266475151.generateUUID();
  }

  namespace_266475151.createCookie(idKey, session_id, 365, calltrk_nearestTLD());
  return session_id;
}

namespace_266475151.generateUUID = function(){
...
namespace_266475151.addLoadEvent = function(new_func){
...
namespace_266475151.startSourceSwap = function(numberQuery){
  var queryResult = namespace_266475151.sourceSwap(namespace_266475151.referrer_key, numberQuery);
...
namespace_266475151.contains = function(a, obj) {
...
namespace_266475151.sourceSwap = function(referrer_key, numberQuery) {
...
(function() {
  ...
  ns.integrationRetry = function() {
    ...
    calltrk_jq.ajax({
      url: "//app.calltrk.com/companies/266475151/c8c6fef00ee1dfbd389f/10/icap.js",
      dataType: 'script',
      cache: false,
      data: data
    });
...
namespace_266475151.referrer = namespace_266475151.getReferrer();
namespace_266475151.landing = namespace_266475151.getLanding();
namespace_266475151.referrer_key = namespace_266475151.getReferrerKey(namespace_266475151.referrer, namespace_266475151.landing);


namespace_266475151.addLoadEvent(namespace_266475151.startSourceSwap);
namespace_266475151.addLoadEvent(namespace_266475151.checkSessionSwap);

(function() {
  var cfg = {"enabled":false,"all_pages":false,"url_whitelist":[]};
  var $ = calltrk_jq, namespace = namespace_266475151,
  ...
  function sendData(data) {
    ...
    var reportUrl = "//app.calltrk.com/companies/266475151/c8c6fef00ee1dfbd389f/10/form_capture";
  ...
  namespace.captureForm = function(form) {
    ...
    if (namespace.readCookie('calltrk_session_id_266475151')) {
...
(function() {
  ...
  // 
  pushNamespace("namespace_266475151");
