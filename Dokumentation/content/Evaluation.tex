...
Das Volumen in dem eine Bluetooth Antenne untergebracht werden kann ist in Kapitel \ref{sec:EigenschaftenAntenne} beschrieben. Das Volumen von 55 x 10 x 3.5 mm (L x B x H) wurde bei den Simulationen berücksichtigt. \\
...
\end{equation}
%\simeq 31.171\dfrac{S^{2}}{\lambda^{4}} ist um den Faktor 1000 zuklein
