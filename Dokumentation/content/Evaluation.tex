...
\subsubsection{Vergleich aus den Simulatioen der Dipolantennen}
...
{
\centering
\includegraphics[width=0.6\textwidth, height=4cm]{content/bilder/Evaluation/Loop/L2/ohneABS/EM_Far_Field_Loop_Lambda2_ohneABS.JPG}
\captionof{figure}{Simulierte 3D Abstrahlcharakteristik eines $\lambda/2$ Loops}
\label{fig:sim_Loop_freiraum_3D}
\medskip
\includegraphics[width=0.6\textwidth, height=4cm]{content/bilder/Evaluation/Loop/L2/1ABS/EM_Far_Field_Loop_Lambda2_mitABS.JPG}
\captionof{figure}{Simulierte 3D Abstrahlcharakteristik eines $\lambda/2$ Loops mit einem ABS Stück im Nahfeld}
\label{fig:sim_Loop_freiraum_3D_1ABS}
\medskip
\includegraphics[width=0.6\textwidth, height=4cm]{content/bilder/Evaluation/Loop/L2/2ABS/EM_Far_Field_Loop_Lambda2_mit2ABS.JPG}
\captionof{figure}{Simulierte 3D Abstrahlcharakteristik eines $\lambda/2$ Loops mit einem ABS Stück im Nahfeld}
\label{fig:sim_Loop_freiraum_3D_2ABS}
%\medskip
...
%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsubsection{Simulierte 3D Richtdiagramme}
{
\centering
\includegraphics[width=0.6\textwidth, height=4cm]{content/bilder/Evaluation/Loop/ohneABS/EM_Far_Field_Loop_Coil_ohneABS.JPG}
\captionof{figure}{Simulierte 3D Abstrahlcharakteristik einer Loop Antenne mit  drei Windungenim Freiraum}
\label{fig:sim_Loop_3Fach_freiraum_3D}
\medskip
\includegraphics[width=0.6\textwidth, height=4cm]{content/bilder/Evaluation/Loop/Mit1ABS/EM_Far_Filed_Loop_Coil_1ABS.JPG}
\captionof{figure}{Simulierte 3D Abstrahlcharakteristik einer Loop Antenne mit  drei Windungenim und einem ABS Stück im Nahfeld}
\label{fig:sim_Loop_3Fach_1ABS_3D}
\medskip
\includegraphics[width=0.6\textwidth, height=4cm]{content/bilder/Evaluation/Loop/Kurz3/EMFraField_Loop_2ABS_kurz3.JPG}
\captionof{figure}{Simulierte 3D Abstrahlcharakteristik einer Loop Antenne mit  drei Windungenim und zwei ABS Stücken im Nahfeld}
