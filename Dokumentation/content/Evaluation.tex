...
\begin{table}[!h]
  \centering
  \begin{tabular}{p{3cm} p{4cm} p{2cm} p{1.5cm} p{2cm} p{2cm} p{2.5cm} l  c c c c p r} 
  \toprule 
  Antenne und Umfeld             & $S_{11_{max}}$ [dB]		& $Z_{ant}$ [$\Omega$] 	& $\eta$ [$\%$] & Bandbreite [MHz] & relative Bandbreite [$\%$]\\ 
  \midrule
Dipol im Freiraum    			&	-16.16 @ 2.42 GHz		&  	68.60-j4			&   	97	&	340 & 12\\         		
 Dipol mit einem ABS Stück  	&   -20.79 @ 2.08 GHz 		&	141.5+j39.6		&	71	&	342	 & 15 \\
Dipol mit zwei ABS Stücken  	&   -28.2 @ 1.82 GHz   	&	206.2-j28		&	59	&	330	 & 17 \\
 \bottomrule
  \end{tabular}
