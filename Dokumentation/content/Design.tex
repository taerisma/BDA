...
\begin{figure}[!ht]
	...
	\input{content/bilder/Simulation/Simulation_S11_5mm_breit.tikz}%=10cm]{}%
	\endgroup
...
\begin{figure}[!ht]
	...
	\begingroup
	\inputencoding{latin1}
	\input{content/bilder/Simulation/Simulation_S11_3mm_breit.tikz}%=10cm]{}%
	\endgroup
...
\begin{figure}[!ht]
	...
	\begingroup
	\inputencoding{latin1}
	\input{content/bilder/Simulation/Simulation_S11_1mm_breit.tikz}%=10cm]{}%
	\endgroup
...
\begin{figure}[!ht]
	...
	\begingroup
	\inputencoding{latin1}
	\input{content/bilder/Simulation/Simulation_S11_Dipol_1mm_Dach.tikz}%=10cm]{}%
	\endgroup
