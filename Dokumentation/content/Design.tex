...
\section{Design Ansatz $\lambda$/2 Dipolantenne}  
...
\end{equation} 
\subsection{Simulatation von verschiedenen Geometrien}
...
\begin{figure}[!ht]
	...
	\endgroup
	\caption{Vergleich des $S_{11}$ im Gehaüse und im Freiraum von Dipolantennen }
