...
\begin{figure}[h]
	...
	\draw[line width=1.5pt](1, 1.5)  -- (3, 1.5);
	\draw[line width=1.5pt](3, 4.75) rectangle (4, 4.25) node at (3.5, 4.75) {$R_Q$};
	\draw[line width=1.5pt](6, 3.5)  -- (6, 4.5);
	\draw[line width=1.5pt](6, 2.5)  -- (6, 1.5);
	\draw[line width=1.5pt](5.75, 2.5) rectangle (6.25, 3.5) node at (5.25, 3) {$R_P$};
	\end{tikzpicture}
	\end{center}
