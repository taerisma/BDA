...
\begin{tikzpicture}
	...
	\draw (4,4) -- (7,4)node at (7.3, 4) {Y};%Fadenkreuz y
...
\begin{tikzpicture}
	...
	\draw[line width=1pt, ->, >=latex](5.5, 6)  -- (6.1, 6.8) node at (6.5, 7) {$\vec{E_{r}}\vec{e}$};
	\draw[line width=1pt, ->, >=latex](5.5, 6)  -- (6.1, 5.6) node at (6.5, 5.4) {$\vec{E_{\theta}}\vec{e}$};
	\draw[line width=1pt, ->, >=latex](5.5, 6)  -- (6.1, 6.3) node at (6.5, 6.1) {$\vec{H_{\phi}}  \vec{e}$};
...
\begin{figure}
	...
	\node at (17, 6) {$\eta=\dfrac{R_{rad}}{Rv+R_{rad}}$};
