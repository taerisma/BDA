...
\begin{figure}[!ht]
	...
	\end{tikzpicture}
	\end{center}
\caption{Leitungsmodell einer Kette von Zweitoren}
\label{fig:LeitungsmodellZweitorKette}
\end{figure}
 Von der Elektrotechnik ist bekannt, dass sich beim Einschalten einer Signalquelle auf der Leitung ein Strom $i(t)$ einstellt. Die Folge davon ist ein magnetisches Feld radial um die Leitung. Der magnetische Fluss ergibt sich mit der Abschnittsinduktivität zu $\Phi = i  \Delta L$. Das einschalten der Quelle führt weiter zu einer Spannung zwischen den Leitern, was zu einem elektrischen Feld und einer Oberflächenladung $Q = u  \Delta C$ auf den Leitern führt \cite{Emant}.
\begin{figure}[!h]
\begin{minipage}{7cm}
	\centering
	\begin{tikzpicture}
