...
Wenn eine 50 Ohm Leitung an eine Antenne angeschlossen wird,  benötigt man  oft ein Anpassnetzwerk zwischen der Leitung und der Antenne.  Da die Impedanzen der Leitung $Z_L$ und der Antenne $Z_{ant}$ nur in seltenen Fällen gleich sind. Antennen haben einen  reellen Strahlungswiderstand $R_{rad}$ und eine Reaktanz $X_{ant}$. Je nach Antennentyp weisst  $X_{ant}$  einen kapazitiven oder  einen induktiven Anteil auf.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{figure}[!htb]
%	\centering
