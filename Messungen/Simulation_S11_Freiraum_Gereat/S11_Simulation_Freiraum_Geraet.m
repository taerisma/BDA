...
saveas(f6,'Vergleich_s11_5mmDipol_Freiraum_Geraet','epsc');
...
saveas(f7,'Vergleich_s11_3mmDipol_Freiraum_Geraet','epsc');
%% S11
% Länge = 24.5mm
% Breite = 1mm
% Dicke = 0.026mm
...
saveas(f8,'Vergleich_s11_1mmDipol_Freiraum_Geraet','epsc');
%% S11
% Länge = 44.25mm
% Breite = 3mm
% Dicke = 0.026mm
...
xlabel('Frequenz in [Hz]')
title('Simulation des  S_{11} im Freiraum und dim Gerät eines Dipol 1mm breit')
saveas(f9,'Vergleich_s11_1mmDipol_Freiraum_Geraet_Dach','epsc');